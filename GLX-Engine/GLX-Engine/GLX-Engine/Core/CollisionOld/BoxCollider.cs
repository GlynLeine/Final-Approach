    ...
    public class BoxCollider : Collider
    {
        ...
        public override bool HitTest(ref Collider other)
        {
            if (other is BoxCollider)
            {
                ...
                //{
                if (LSINarrowPhase(hullA, positionA, velocityA, hullB, positionB, out colPos))
                {
                    //m_minimumTranslationVec = m_minimumTranslationVec + (colPos - (positionA + velocityA)) / 2;
                    return SATNarrowPhase(hullA, colPos, hullB, colPos);
                }
                //}
                ...
                //    {
                //        m_minimumTranslationVec = m_minimumTranslationVec + (colPos - (positionA + velocityA)) / 2;
                //        return SATNarrowPhase(hullA, colPos, hullB, colPos, ref other);
                //    }
                //}
                //else
                //{
                //    if (LSINarrowPhase(hullB, positionB, velocityB, hullA, positionA, out colPos))
                //    {
                //        m_minimumTranslationVec = m_minimumTranslationVec + (colPos - (positionA + velocityA)) / 2;
                //        return SATNarrowPhase(hullA, colPos, hullB, colPos, ref other);
                //    }
        ...
        //														LSINarrowPhase()
        //------------------------------------------------------------------------------------------------------------------------
        private bool LSINarrowPhase(Vector2[] hullA, Vector2 positionA, Vector2 velocityA, Vector2[] hullB, Vector2 positionB, out Vector2 colPos)
        {
